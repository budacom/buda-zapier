const allCurrencies = [
  ...
  { code: 'CLP', name: 'Chilean Pesos', crypto: false, canWithdraw: true },
  { code: 'COP', name: 'Colombian Pesos', crypto: false, canWithdraw: false },
  { code: 'PEN', name: 'Colombian Pesos', crypto: false, canWithdraw: false },
];
